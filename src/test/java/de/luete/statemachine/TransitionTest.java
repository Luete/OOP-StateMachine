...
public class TransitionTest
{
	...
	public void setUp()
	{
		...
		transitions.add(new StateTransition<TransitionTest.States>(States.INITIAL, States.SECOND));
		transitions.add(new StateTransition<TransitionTest.States>(States.SECOND, States.TROLL));
		transitions.add(new StateTransition<TransitionTest.States>(States.SECOND, States.INITIAL));
		transitions.add(new StateTransition<TransitionTest.States>(States.TROLL, States.FOURTY_TWO));
		transitions.add(new StateTransition<TransitionTest.States>(States.FOURTY_TWO, States.FOURTH));
		transitions.add(new StateTransition<TransitionTest.States>(States.FOURTH, States.FINISH));
		
		_stateMachine = new StateMachine<States>(States.INITIAL, transitions);
	}
